                    ...
                    <tr>
                        ...
                        <td>
                            <form method="post" action="">
                                ...
                                <button type="submit" name="remove_from_userlist" class="option-btn"
                                    style="background-color:var(--red);">Delete</button>
                            </form>
                        </td>
...
?>
            ...
            <div class="checkout-btn">
                <a href="product.php" class="option-btn" style="margin-top: 0;background-color:var(--blue);">Continue
                    Shopping</a>
            </div>
        </section>
    </div>
