            ...
            <div class="swiper-wrapper" id="product-slider-container">
                ...
                <div class="swiper-slide">
                    ...
                    <form action="" method="post">
                        <div class="box">
                            <img src="images/<?php echo ($fetch_product['category'] == 'fruit') ? 'fruits/' : 'vegetables/'; ?><?php echo $fetch_product['image']; ?>"
                                alt="">
                            ...
                            <button type="submit" class="wishlist-btn" onclick="toggleActionValue(event)"><i
        ...
        <div class="swiper product-slider">
            ...
            <div class="swiper-wrapper" id="product-slider-container">
                ...
                <div class="swiper-slide">
                    ...
                    <form action="" method="post">
                        <div class="box">
                            <img src="images/<?php echo ($fetch_product['category'] == 'fruit') ? 'fruit_dairy/' : 'vegetables/'; ?><?php echo $fetch_product['image']; ?>"
                                alt="">
                            <h3><?php echo $fetch_product['name']; ?></h3>
                            <div class="price">$<?php echo $fetch_product['price']; ?>/-</div>
                            <input type="hidden" name="product_category"
